namespace Treebank.Mappers
{
    ...
    public class ConllxDocumentMapper : IDocumentMapper
    {
        ...
        public async Task<Document> Map(string filepath, string configFilepath, DataStructure dataStructure = null, Definition definitionParam = null)
        {
            ...
            var datastructure =
                appConfig.DataStructures.FirstOrDefault(d => d.Format == ConfigurationStaticData.ConllxFormat || d.Format == ConfigurationStaticData.ConllFormat);
